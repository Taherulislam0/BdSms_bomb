...
DEVELOPER :prince shawon
GITHUB    : 😄😄 fuk you😄
VERSION   : 2.0
PROJECT   : SMS BOMBER 
FACEBOOK  : Prince Shawon 
××××××××××××××××××××××××××××××××××××××××××××"""
  for i in logo:
    sys.stdout.write(i)
    sys.stdout.flush()
...
××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ DEVELOPER : Prince shawon 😈
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ GITHUB    : 😄😄fuk you😄
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ VERSION   : 2.0
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ PROJECT   : SMS BOMBING 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ FACEBOOK  : prince shawon
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
